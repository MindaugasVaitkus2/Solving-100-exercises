...
# return will return the value, while print only prints it on the screen. So for us to have the value and multiply 10 to it we need to use return and then print. 
